        ...
        <>
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  'radial-gradient(ellipse at 10% 0%, rgba(41,171,226,0.14) 0%, transparent 55%), radial-gradient(ellipse at 90% 100%, rgba(232,23,138,0.10) 0%, transparent 55%)',
              }}
            />

            {/* Drawer header */}
            <div className="relative flex items-center justify-between px-5 h-20 border-b border-white/10">
              <Link href="/" onClick={close} className="flex items-center gap-3">
                <LogoDrawing className="h-10 w-auto" />
                <LogoText className="h-7 w-auto brightness-0 invert" />
              </Link>
              <button
                onClick={close}
              ...
              {navLinks.map(({ label, href }, i) => (
                <Link
                  ...
                  style={{
                    ...
                    transitionTimingFunction: 'cubic-bezier(0.32, 0.08, 0.24, 1), ease',
            ...
            {/* CTA button */}
            <div
              className="relative px-5 pb-10 [&_.shimmer-ring]:block [&_.shimmer-ring]:w-full"
              style={{
                transitionProperty: 'transform, opacity',
                transitionDuration: '0.4s, 0.4s',
                transitionTimingFunction: 'cubic-bezier(0.32, 0.08, 0.24, 1), ease',
                transitionDelay: isOpen ? `${55 + navLinks.length * 40}ms` : '0ms',
      ...
      <div className="md:hidden px-4 h-20 flex items-center">
        ...
        <button
          ...
          className="shrink-0 flex flex-col justify-center items-start w-10 h-10 gap-1.25
                     rounded-lg hover:bg-brand-navy/5 transition-colors duration-200 px-2"
        >
          <span
            className="block h-0.5 bg-brand-navy rounded-full transition-all duration-300 origin-center"
            style={{
              width: '18px',
          ...
          />
          <span
            className="block h-0.5 bg-brand-navy rounded-full transition-all duration-300"
            style={{
              width: '14px',
              opacity: isOpen ? 0 : 1,
